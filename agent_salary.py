...
# inputs
agent_id = input("Enter the agent unique ID: ")
month_selected = input("Enter the month for which you want to determine the salary(*Example: 01 for January): ")
...
class AgentSalary():
    ...
    def __init__(self,agent_id,month_selected):
        self.agent = agent_id 
